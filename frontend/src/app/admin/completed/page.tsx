...
import { getCompletedAppointmentsAdmin } from '@/app/shared/api/appointments.api';
...
export default function Page() {
  ...
  const fetchCompletedAppointments = async () => {
    const res = await getCompletedAppointmentsAdmin();
  ...
  return (
    <div className="p-6 bg-gray-950 min-h-screen text-gray-100">
      <h1 className="text-2xl font-semibold mb-6">Completed Appointments</h1>
                  ...
                  {list.map((a: any) => (
                    ...
                    >
                      ...
                      <td className="px-5 py-3">
                        <span className="px-3 py-1 rounded-full text-xs font-medium bg-green-900/40 text-green-300">
                          completed
                        </span>
                      </td>
                    </tr>
