...
import { getNotificationsPharmacistApi, markAllNotificationsReadPharmacist, markNotificationReadPharmacist } from '@/app/shared/api/pharmacy.api'
...
export default function Page() {
  ...
  const handleMarkRead = async (n_id: string) => {
    try {
      await markNotificationReadPharmacist(n_id)
  ...
  const handleReadAll = async () => {
    try {
      await markAllNotificationsReadPharmacist()
      setNotifications(prev =>
